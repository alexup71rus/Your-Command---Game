...
const en: LocaleDictionary = {
  ...
  game: {
    ...
    troopDescriptions: { militia: 'Cheap troops with baseline damage and durability.', spearmen: 'Shields reduce incoming arrow damage by 40%.', archers: 'Shoot up to 8 cells away; each volley costs 2 orders.', knights: 'Heavy armour reduces arrow damage by 82%, but movement costs twice as much.' },
    selectCell: 'Select an object or cell on the map', emptyCell: 'Open ground', castle: 'Castle', squad: 'Squad',
    terrainPlain: 'Plain', terrainHill: 'Height', terrainForest: 'Forest', hitPoints: 'Durability', defense: 'Defense', squadHealth: 'Endurance', damage: 'Damage', movementCost: 'Step', rangedDefense: 'Arrows', cost: 'Cost', free: 'Free', emergencyFree: 'Your first lumber mill is free when you cannot afford its wood cost.', perTurn: 'per turn',
    ...
    buildHint: 'Choose a suitable cell inside your domain.', recruitHint: 'Choose a cell next to your castle or barracks.', moveHint: 'Choose an adjacent cell or a free cell beyond your barbican. Forest doubles the cost of a step.', knightMoveHint: 'Knights double the cost of a step, and forest doubles it once more.', archerRangeHint: 'Archers shoot in a straight line up to 8 cells away; a volley costs 2 orders.', routeUnavailable: 'There is no clear path to that cell.', routeOrdersFinished: 'No orders remain — movement has stopped.', splitHint: 'Set the composition and choose a free adjacent cell.', dismissHint: 'Choose troops to return them to the civilian population without a resource refund.', garrisonEnterHint: 'Choose an adjacent squad containing archers.', garrisonExitHint: 'Choose an adjacent empty cell.', towerAttackHint: 'Choose an enemy target aligned with the tower; a volley costs 2 orders.', squadActionHint: 'Move / attack', splitNewSquad: 'New squad', splitRemaining: 'Remaining',
