...
const en: LocaleDictionary = {
  ...
  hud: {
    state: 'Domain status', resources: 'Resources', people: 'Civilians', army: 'Recruited troops', turn: 'Current turn', ordersAvailable: 'Orders available', workers: 'Employed', freePeople: 'Free', diverseDiet: 'Varied diet',
  },
  ...
  game: {
    ...
    troopDescriptions: { militia: 'Cheap troops with baseline damage and durability.', spearmen: 'Slightly stronger and tougher than militia, but cheaper than archers.', archers: 'Fight like militia up close but shoot up to 5 cells away.', knights: 'Spearman damage, high durability and doubled movement cost.' },
    ...
    terrainPlain: 'Plain', terrainHill: 'Height', terrainForest: 'Forest', hitPoints: 'Durability', squadSize: 'Troops', squadHealth: 'Endurance', orders: 'orders', cost: 'Cost', perTurn: 'per turn',
    ...
    buildHint: 'Choose a suitable cell inside your domain.', recruitHint: 'Choose a cell next to your castle or barracks.', moveHint: 'Choose an adjacent cell to move, merge or attack. Forest doubles the cost of a step.', knightMoveHint: 'Knights double the cost of a step, and forest doubles it once more.', archerRangeHint: 'Archers shoot in a straight line up to 5 cells away.', routeUnavailable: 'There is no clear path to that cell.', routeOrdersFinished: 'No orders remain — movement has stopped.', splitHint: 'Choose a free adjacent cell for the new squad.',
