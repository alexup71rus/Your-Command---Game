...
const en: LocaleDictionary = {
  ...
  opponents: {
    ...
    profiles: {
      ...
      velislava: { name: 'Velislava of the Frontier', strategy: 'Fortifies passages, protects archers and readily raids exposed economies.', toolkit: 'Farms · archers · walls · barbicans' },
      svyatobor: { name: 'Svyatobor Ironhand', strategy: 'Plans several turns ahead, combining industry, sieges and measured raids.', toolkit: 'Iron · knights · market · tower garrisons' },
    },
  },
  founding: {
