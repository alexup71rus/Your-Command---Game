...
const en: LocaleDictionary = {
  ...
  game: {
    ...
    cancel: 'Cancel', split: 'Split', dismiss: 'Dismiss', confirmDismiss: 'Confirm', garrison: 'Garrison', garrisonEnter: 'Enter', garrisonExit: 'Exit', towerAttack: 'Fire', towerRange: 'Range', towerSight: 'Sight', towerCapacity: 'Archers', armyLimit: 'Army', endTurn: 'End turn', opponentTurn: 'Opponent turn', endTurnHint: 'Production yields resources while civilians and troops consume grain and meat.', production: 'Production', foodDemand: 'Food use', populationCapacity: 'Population capacity',
