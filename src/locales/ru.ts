...
const ru: LocaleDictionary = {
  ...
  game: {
    resourceNames: { wood: 'Дерево', stone: 'Камень', ore: 'Руда', iron: 'Железо', grain: 'Зерно', meat: 'Мясо', fruit: 'Фрукты', gold: 'Золото' },
    ...
    buildingDescriptions: {
      ...
      farm: 'Массово производит зерно на равнине и требует работающую мельницу.',
  ...
  sound: {
    ...
    musicTitle: 'Музыка',
    musicDescription: 'Спокойная тема сменяется боевой при видимой угрозе',
