...
const en: LocaleDictionary = {
  ...
  sound: {
    title: 'Sound', description: 'The master switch controls music and interface effects', effectsVolume: 'Effects', musicTitle: 'Music', musicDescription: 'The calm theme gives way to battle music when a visible threat appears', musicVolume: 'Music volume', enable: 'Enable sound', disable: 'Disable sound', enabled: 'On', disabled: 'Off',
  },
  contextMenu: {
