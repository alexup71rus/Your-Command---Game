...
const ru: LocaleDictionary = {
  ...
  game: {
    ...
    buildingNames: { farm: 'Ферма', lumberMill: 'Лесопилка', quarry: 'Каменоломня', house: 'Дом', barracks: 'Казарма', church: 'Церковь', wall: 'Стена', tower: 'Башня', barbican: 'Барбакан' },
    ...
    troopNames: { militia: 'Ополчение', spearmen: 'Копейщики', archers: 'Лучники' },
    troopDescriptions: { militia: 'Дешёвые бойцы для защиты и набегов.', spearmen: 'Крепкий основной строй с железным оружием.', archers: 'Дальнобойные бойцы, сильнее на высоте.' },
    ...
    terrainPlain: 'Равнина', terrainHill: 'Высота', terrainForest: 'Лес', hitPoints: 'Прочность', squadSize: 'Бойцов', orders: 'приказа', perTurn: 'за ход',
    ...
    buildHint: 'Выберите подходящую клетку внутри своего владения.', recruitHint: 'Выберите клетку рядом с замком или казармой.', moveHint: 'Выберите соседнюю клетку для движения, объединения или атаки.', splitHint: 'Выберите свободную соседнюю клетку для нового отряда.',
    ...
    previousItems: 'Предыдущие постройки', nextItems: 'Следующие постройки',
    failures: {
      ...
      'squad-full': 'В одной клетке может быть не больше 10 бойцов.', 'invalid-squad': 'Нельзя сформировать такой отряд.', 'cannot-demolish': 'Замок нельзя снести.',
    },
  },
  interface: {
